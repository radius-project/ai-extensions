...
import { deployStatusKeys, lookupDeployStatus } from "../../graph/deployed.js";
import type { DeployStatus } from "../../graph/deployed.js";
...
export function createDeployStatusReader(options: DeployStatusReaderOptions) {
  ...
  if (
    ...
    throw new Error(
      "Deployment artifact reader requires listing and download ports."
    );
  }
