...
import {
  ...
  DELETE_ENV_DISPATCHER_TEMPLATE,
  DELETE_ENV_PROVIDER_TEMPLATE,
  DELETE_RESOURCE_DISPATCHER_TEMPLATE,
...
const deleteTemplates = {
  ...
  [DELETE_RESOURCE_DISPATCHER_FILE]: DELETE_RESOURCE_DISPATCHER_TEMPLATE,
  [DELETE_ENV_DISPATCHER_FILE]: DELETE_ENV_DISPATCHER_TEMPLATE,
  [DELETE_ENV_AZURE_FILE]: DELETE_ENV_PROVIDER_TEMPLATE,
