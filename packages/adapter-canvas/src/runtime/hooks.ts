...
export async function evaluateAppBicepHook(
  ...
  return {
    permissionDecision: "deny",
    permissionDecisionReason: `The .radius/app.bicep on \`${outdated.branch}\` must be regenerated by the radius-app-bicep skill before the application graph can be trusted.`,
