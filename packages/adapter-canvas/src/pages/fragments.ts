...
export const DELETE_DEPLOYMENT_DIALOG_HTML = `<div id="deploy-delete-modal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.45); z-index:50; align-items:center; justify-content:center;">
...
export const ABANDON_DEPLOYMENT_DIALOG_HTML = `<div id="deploy-abandon-modal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,0.45); z-index:50; align-items:center; justify-content:center;">
  <div class="rad-ddlg" role="dialog" aria-modal="true" aria-labelledby="deploy-abandon-title">
    <div class="rad-ddlg__header">
      <span class="rad-ddlg__title" id="deploy-abandon-title">Abandon Failed Deployment</span>
      <button type="button" class="rad-ddlg__close" id="deploy-abandon-close" aria-label="Close">✕</button>
    </div>
    <div class="rad-ddlg__info">
      <span class="rad-ddlg__info-icon" aria-hidden="true"><svg width="22" height="22" viewBox="0 0 24 24" fill="none"><rect x="3" y="3" width="7" height="7" rx="1.5" stroke="currentColor" stroke-width="1.8"/><rect x="14" y="3" width="7" height="7" rx="1.5" stroke="currentColor" stroke-width="1.8"/><rect x="3" y="14" width="7" height="7" rx="1.5" stroke="currentColor" stroke-width="1.8"/><rect x="14" y="14" width="7" height="7" rx="1.5" stroke="currentColor" stroke-width="1.8"/></svg></span>
      <span class="rad-ddlg__app" id="deploy-abandon-app"></span>
      <span class="rad-ddlg__env">Environment: <strong id="deploy-abandon-env"></strong></span>
    </div>
    <div class="rad-ddlg__content" id="deploy-abandon-body"></div>
  </div>
</div>`;
