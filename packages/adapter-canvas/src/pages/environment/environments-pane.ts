...
<div id="env-form" style="display:none;">
  ...
  <div class="rad-card">
    ...
    <div class="rad-section">
      ...
      <div class="rad-section__desc">Radius wires a passwordless OIDC trust so GitHub Actions can deploy into this environment — no secrets stored in the repo. Both sides are required: confirm the GitHub account first, then the cloud credentials it deploys with.</div>
      ...
      <div class="rad-conn">
        ...
        <div class="rad-conn__side">
          <div class="rad-conn__badge">
            <span class="rad-conn__ord">First</span>
        ...
        <div class="rad-conn__side">
          <div class="rad-conn__badge">
            <span class="rad-conn__ord">Then</span>
