...
- `runtime-compatibility.json` records the accepted Phase 0 metadata, seven page values, retained and removed names, 38 route method/path pairs, stable page markers, branch-selection behavior, and built artifact path.
