...
single generated artifact, `.github/radius/extension.mjs`.
...
- **Generated artifact**: `.github/radius/extension.mjs` is produced by `adapters/canvas/build.mjs` — never hand-edited. If adapter/core source changed, confirm the bundle was rebuilt (`pnpm run build`) and is in sync.
