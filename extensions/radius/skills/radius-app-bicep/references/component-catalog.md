...
| App secrets (API keys, tokens); DB creds when the schema takes a secret reference | env-injected secrets; API keys in config                                                                                                          | `Radius.Security/secrets`         | supporting                                   |
