...
| Reused app owned by Azure CLI user                | `BLOCKED` | Existing owned identity is reused and never enters this operation's deletion authority.                                                                                   | None              |
| Reused app owned by Azure CLI service principal   | `BLOCKED` | Existing owned identity is reused and never enters this operation's deletion authority.                                                                                   | None              |
| Matching app not owned by Azure CLI caller        | `BLOCKED` | Radius refuses unauthorized adoption and deletes nothing.                                                                                                                 | None              |
