...
**Stage 1A delivery:** The user requested two replacement PRs for the original draft [#887](https://github.com/radius-project/ai-extensions/pull/887), pinned at `dd3b37d31f33482180c538b611cecbabd4e0f26c`. The first, [#889](https://github.com/radius-project/ai-extensions/pull/889), provides core/shared observation, diagnostics, reads and boundary enforcement while deliberately leaving Canvas unchanged. The second, `nellshamrell-stage-1a-canvas-workflow-adoption`, depends on #889 at `671fd25ee17812603c99fed770e6eb36315aad1e` and adopts those implementations in Canvas, removing the duplicated policies and moving their tests to their owners. Core now owns known-run normalization and terminal failure collection; shared owns argv/JSON/fallback and ambient/selected read semantics. Canvas retains dispatch, discovery, polling, artifacts/cache, graph projection, narration, attempt state and repair. See the [Stage 1A ownership record](./2026-09-github-radius-migration-inventory.md#stage-1a-workflow-observation) for compatibility exports, source-equivalence proof, limitations and per-layer evidence. These replacement drafts do not authorize landing or complete Stage 1; evidence corrections, artifact extraction and retries remain separate 1B, 1C and 1D changes.
