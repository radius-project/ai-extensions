...
| 4     | Implementation in progress; stacked on #379                        | Make browser behavior importable and compile it inline               | BU-01–BU-14 are the active acceptance scope; generated scripts and renderer wiring must pass; no duplicate behavior source may remain         | Draft [#386](https://github.com/radius-project/ai-extensions/pull/386)                                                                                                                                                                                                                                               |
