...
|-------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| 0     | Complete: compatibility records, coverage reporting, and removal of four legacy action/tool pairs                                                                          | [#318](https://github.com/radius-project/ai-extensions/pull/318)                                                                   |
| 1     | Complete: runtime factories and their unit, runtime-integration, and artifact checks                                                                                       | [#288](https://github.com/radius-project/ai-extensions/pull/288), [#318](https://github.com/radius-project/ai-extensions/pull/318) |
| 2     | Not merged: scaffolding is proposed in [#339](https://github.com/radius-project/ai-extensions/pull/339); all 37 routes remain on an explicitly inventoried legacy fallback | [#339](https://github.com/radius-project/ai-extensions/pull/339)                                                                   |
| 3–8   | Not started                                                                                                                                                                | [#334](https://github.com/radius-project/ai-extensions/issues/334)                                                                 |
