...
| Over-broad GitHub privilege                         | A dedicated App is installed only on the fixture repository. Its only administration grant is read-only access to inspect the OIDC subject template; it has no repository-administration write, members, hooks, or organization permissions. Contents, Actions, Environments, Variables, Secrets, Workflows, and Pull requests are writable only because the lifecycle or its bounded cleanup uses those repository-scoped operations.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
