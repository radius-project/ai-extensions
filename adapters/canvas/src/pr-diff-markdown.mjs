...
const STATUS_STYLE = { added: ":::added", removed: ":::removed", modified: ":::modified", unchanged: ":::unchanged" };
const STATUS_ICON = { added: "🟢", removed: "🔴", modified: "🟡", unchanged: "" };
...
export function renderDiffMermaid(diffResources) {
    ...
    edgeStatuses.forEach((st, i) => {
        if (st === "added") mermaid += `    linkStyle ${i} stroke:#1a7f37,stroke-width:2px\n`;
        else if (st === "removed") mermaid += `    linkStyle ${i} stroke:#cf222e,stroke-width:2px\n`;
    });
