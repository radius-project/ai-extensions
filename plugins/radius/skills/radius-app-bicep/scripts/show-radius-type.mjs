...
function windowsTaskkillPath(env = process.env) {
  ...
  return systemRoot ? pathWin32.join(systemRoot, "System32", "taskkill.exe") : "taskkill";
}
function killChildTree(child, platform = process.platform) {
...
function radSpawnOptions(platform = process.platform) {
  return {
